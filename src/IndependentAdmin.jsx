...
=======
  ...
  return (
    <div style={iaStyles.container}>
      <aside style={iaStyles.sidebar}>
        <h2 style={iaStyles.title}>CASINO MASTER</h2>
        <div style={iaStyles.onlineBadge}>
           <div style={{color:'#888', fontSize:13, marginBottom:5}}>NOW ONLINE</div>
        ...
        <div style={{height:1, background:'#333', margin:'10px 0'}}></div>
        <div onClick={() => setTab("event")} style={tab === "event" ? iaStyles.menuActive : iaStyles.menu}>🎰 바카라 조작</div>
        ...
        <div onClick={() => setTab("sponsorships")} style={tab === "sponsorships" ? iaStyles.menuActive : iaStyles.menu}>💎 베팅 내역</div>
